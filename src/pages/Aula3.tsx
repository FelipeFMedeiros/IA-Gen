...
const Aula3 = () => {
    ...
    const referencias = [
        ...
        { titulo: 'CIDDL. Generative AI Prompt Engineering for Educators. 2025.', link: 'https://ciddl.org/ciddl-research-and-practice-brief-generative-ai-prompt-engineering-for-educators/' },
        { titulo: 'ERIC. The Future of Artificial Intelligence in Special Education. 2024.', link: 'https://files.eric.ed.gov/fulltext/EJ1387002.pdf' },
        { titulo: 'NATIONAL CENTER ON ACCESSIBLE EDUCATIONAL MATERIALS. AI & Accessibility: Supporting All Learners. 2024.', link: 'https://aem.cast.org/get-started/resources/2024/ai--accessibility-supporting-all-learners' },
        { titulo: 'OECD. Leveraging artificial intelligence to support students with special education needs. 2025.', link: 'https://www.oecd.org/en/publications/leveraging-artificial-intelligence-to-support-students-with-special-education-needs_1e3dffa0-en.html' },
        ...
        { titulo: 'DAVILA-MORAN, R. C. et al. Brief Prompt-Engineering Clinic Substantially Improves AI Literacy and Reduces Technology Anxiety in First-Year Teacher-Education Students: A Pre-Post Pilot Study. Education Sciences, v. 15, n. 8, p. 1010, 2025.', link: 'https://doi.org/10.3390/educsci15081010' },
        ...
        { titulo: 'KHAN ACADEMY. Engenharia de prompt para planos de aula. Blog Khan Academy, 2026.', link: 'https://blog.khanacademy.org/pt-br/engenharia-de-prompt-para-planos-de-aula/' },
        ...
        { titulo: 'SAKOWICZ, M.; HAMIDI, F. Exploring the role of generative AI in supporting students with disabilities, through the lens of universal design for learning. American Journal of STEM Education, v. 15, p. 1-22, 2025.', link: 'https://doi.org/10.32674/yeyaaq64' },
        { titulo: 'SILVA, T. O.; OLIVEIRA, J. M. L.; JENNINGS, C. A. F. Mineração de Dados Educacionais e Inteligência Artificial Aplicadas à Adaptação Curricular em Contextos Inclusivos. Revista Tópicos, Rio de Janeiro, v. 4, n. 32, p. 1-15, 2026.', link: 'https://doi.org/10.70773/revistatopicos/776517243' },
