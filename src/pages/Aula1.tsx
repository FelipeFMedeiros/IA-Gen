...
const Aula1 = () => {
    ...
    const prompts = [
        {
            titulo: 'Prompt 1: O Prompt Ingênuo',
            texto: 'Crie uma atividade de ciências sobre planetas para o 5ºano.',
        },
        {
            titulo: 'Prompt 2: O Prompt Estruturado',
            texto: '[Persona] Atue como professor de AEE. [Tarefa] Crie uma atividade sobre planetas. [Contexto] É para um aluno do 5ºano com dislexia severa. [Formato] Apresente em tópicos, use linguagem simples e gere 3 questões de múltipla escolha focadas no visual.',
        },
    ];
