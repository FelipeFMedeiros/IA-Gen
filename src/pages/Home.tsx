...
const Home = () => {
    const aulas = [
        ...
        },
        {
            ...
            descricao: 'Aprenda a criar prompts eficazes para obter melhores resultados das IAs',
            icon: '⚡',
        ...
        },
        {
            ...
            descricao: 'Criação de Relatórios de Desenvolvimento Individualizado com auxílio da IA',
            icon: '📝',
